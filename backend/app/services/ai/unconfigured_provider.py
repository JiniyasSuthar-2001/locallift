...
class UnconfiguredAIProvider(AIProvider):
    ...
    async def generate_content_opportunities(self, context: Dict[str, Any]) -> List[Dict[str, Any]]:
        raise RuntimeError("AI_NOT_CONFIGURED: AI_API_KEY environment variable is not configured. Please add a valid AI API key to enable AI content opportunities.")
